...
formPreguntas.addEventListener('submit', function (e) {
    ...
    for (var i = 1; i <= preguntas.length; i++) {
        respuesta = formPreguntas.elements["pregunta" + i];

        // SUMAR POR SEPARADO CADA VALOR
    ...
    var puntajePreguntas = preguntas.length;
    // MOSTRAR SWEET ALERT CON BOTÓN
    console.log("don1: " + valor1 / puntajePreguntas * 100);
    console.log("don2: " + valor2 / puntajePreguntas * 100);

    // VER CÓMO PODER GUARDAR O COMPARTIR TU DON
